...
public class Controller {
    ...
    private void optionalSignIn() throws ExecutionException {
        Scanner sc = new Scanner(System.in);
        boolean correctSelection;
        do {
            System.out.println("Quieres registrar a un nuevo usuario: (s/n)");
    ...
    private void logIn() throws LogicExceptions, ExecutionException {
